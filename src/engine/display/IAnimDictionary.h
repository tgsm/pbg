...
public:
    ...
    virtual std::string* FindAnimationID(IAnimation*) = 0; // Skeptical about the return type. Same for other Find[...]ID functions
    virtual U32 GetNumberOfAnimations() = 0;
    ...
    virtual U32 GetNumberOfDMorphAnimations() = 0;
    ...
    virtual U32 GetNumberOfMaterialAnimations() = 0;
    ...
    virtual U32 GetNumberOfEventAnimations() = 0;
    ...
    virtual U32 GetNumberOfControllers() = 0;
    ...
    virtual CAnimationStar* LoadAnimationStarFromChunk(std::string, DkXmd::CChunkIterator*, DkXmd::CXmdFile*, void*) = 0;
    virtual CAnimationStar* FindAnimationStar(std::string) = 0;
    virtual std::string* FindAnimationStarID(IAnimationStar*) = 0;
    virtual U32 GetNumberOfAnimationStars() = 0;
    ...
    virtual U32 GetNumberOfAnimationStarControllers() = 0;
