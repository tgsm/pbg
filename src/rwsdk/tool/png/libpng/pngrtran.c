      ...
      if (png_ptr->transformations & PNG_BACKGROUND)
      {
         if (color_type == PNG_COLOR_TYPE_PALETTE)
         {
            ...
            else
            {
               ...
               {
                  back.red = (png_byte)(float)(pow(
                     (double)png_ptr->background.red/255, gs) * 255.0 + .5);
                  back.green = (png_byte)(float)(pow(
                     (double)png_ptr->background.green/255, gs) * 255.0 + .5);
                  back.blue = (png_byte)(float)(pow(
                     (double)png_ptr->background.blue/255, gs) * 255.0 + .5);
               }

               back_1.red = (png_byte)(float)(pow(
                  (double)png_ptr->background.red/255, g) * 255.0 + .5);
               back_1.green = (png_byte)(float)(pow(
                  (double)png_ptr->background.green/255, g) * 255.0 + .5);
               back_1.blue = (png_byte)(float)(pow(
         ...
         /* color_type != PNG_COLOR_TYPE_PALETTE */
         {
            ...
            {
               /* RGB or RGBA */
               png_ptr->background_1.red = (png_uint_16)(float)(pow(
                  (double)png_ptr->background.red / m, g) * m + .5);
               png_ptr->background_1.green = (png_uint_16)(float)(pow(
                  (double)png_ptr->background.green / m, g) * m + .5);
               png_ptr->background_1.blue = (png_uint_16)(float)(pow(
                  (double)png_ptr->background.blue / m, g) * m + .5);
               png_ptr->background.red = (png_uint_16)(float)(pow(
                  (double)png_ptr->background.red / m, gs) * m + .5);
               png_ptr->background.green = (png_uint_16)(float)(pow(
                  (double)png_ptr->background.green / m, gs) * m + .5);
               png_ptr->background.blue = (png_uint_16)(float)(pow(
                  (double)png_ptr->background.blue / m, gs) * m + .5);
            }
            else
            {
               /* GRAY or GRAY ALPHA */
               png_ptr->background_1.gray = (png_uint_16)(float)(pow(
                  (double)png_ptr->background.gray / m, g) * m + .5);
               png_ptr->background.gray = (png_uint_16)(float)(pow(
...
png_build_gamma_table(png_structp png_ptr)
{
  ...
  if(png_ptr->gamma != 0.0)
  {
   if (png_ptr->bit_depth <= 8)
   {
      ...
      for (i = 0; i < 256; i++)
      {
         png_ptr->gamma_table[i] = (png_byte)(float)(pow((double)i / 255.0,
            g) * 255.0 + .5);
      }
    ...
    defined(PNG_READ_RGB_TO_GRAY_SUPPORTED)
      if (png_ptr->transformations & ((PNG_BACKGROUND) | PNG_RGB_TO_GRAY))
      {
         ...
         for (i = 0; i < 256; i++)
         {
            png_ptr->gamma_to_1[i] = (png_byte)(float)(pow((double)i / 255.0,
               g) * 255.0 + .5);
         }
         ...
         for (i = 0; i < 256; i++)
         {
            png_ptr->gamma_from_1[i] = (png_byte)(float)(pow((double)i / 255.0,
               g) * 255.0 + .5);
   ...
   else
   {
      ...
      if (png_ptr->transformations & (PNG_16_TO_8 | PNG_BACKGROUND))
      {
         ...
         for (i = 0; i < 256; i++)
         {
            ...
            fin = pow(fout, g);
            max = (png_int_32)(float)(fin * (double)((png_uint_32)num << 8));
            while (last <= max)
            {
         ...
         for (i = 0; i < num; i++)
         {
            ...
            for (j = 0; j < 256; j++)
            {
               png_ptr->gamma_16_table[i][j] =
                  (png_uint_16)(float)(pow((double)(ig + ((png_uint_32)j << 8)) /
                     65535.0, g) * 65535.0 + .5);
            }
         }
      }
